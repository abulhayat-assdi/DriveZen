...
export const CONTENT_FIELDS: ContentField[] = [
  ...
  // product (Admin → Products), everything below is edited here.
  {
    ...
    type: "image",
    default: "/seed/dz-fit-light.webp",
  },
  {
    key: "before_image",
  ...
  { key: "customer_photo_2", label: "Customer photo strip 2 — square", group: "Section Images", type: "image", default: "/seed/dz-hero-driver.webp" },
